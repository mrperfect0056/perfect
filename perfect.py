...
\033[1;94m ┈┈┈▕▕Perfect▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕Perfect▏▏┈┈┈

\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈▏┈┈┈

\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mPerfect.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
...
\033[1;92m☞ WhatsApp   : +8801982423672

\033[1;95m☞ YouTube    : https://youtube.com/channel/UCXItn4AnlxExhW0virHuD3Q

-HACKING IS NOT CRIME ITS AGAME AGAINST OF THE SYSTEM~√
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update BSF-52_perfect Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' _BSF-52 ')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num +8801982423672✓')
...
✓')
	    ...
	    psb('🔓Password ☆Perfect ✓')

	    psb('Subscrib My Youtube Channel .//..........✓')
